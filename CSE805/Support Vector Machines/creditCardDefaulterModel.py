...
# Display the results
TN, FP, FN, TP = cm.ravel()  # Flattens the confusion matrix into a one-dimensional array
...
scatter = plt.scatter(X_train_pca[:, 0], X_train_pca[:, 1], c=y_train, edgecolors='k', cmap=plt.cm.RdYlBu, marker='o')
